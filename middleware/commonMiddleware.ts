...
export const setupMiddlewares = (app: Application): void => {
  ...
  /* eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion, @typescript-eslint/no-unnecessary-type-assertion -- i18next's default export is the singleton instance at runtime, but its module type is incompatible with i18next-http-middleware's i18n type */
